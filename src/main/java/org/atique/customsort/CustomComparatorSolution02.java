...
public class CustomComparatorSolution02 {
    ...
    static class CustomComparator implements Comparator<Transaction> {
        @Override
        public int compare(Transaction o1, Transaction o2) {
            int result = o1.sourceAccount.compareTo(o2.sourceAccount);
            if (result != 0) return result;

            result = o1.targetAccount.compareTo(o2.targetAccount);
            if (result != 0) return result;

            result = o1.amount.compareTo(o2.amount);
            if (result != 0) return result;

            Long time1 = Transaction.getTimeInMillisFromString(o1.getTime());
            Long time2 = Transaction.getTimeInMillisFromString(o2.getTime());
